...
#GOOGLE_API_KEY = "AIzaSyCNWF23V-EkC2qSyfWazLf74eYsE0GjXDM"
...
if choice == "名片識別":
    ...
    if uploaded_file:
        ...
        # 建立 ContactPerson 物件
                        ...
                        #server_url = "http://172.16.11.30:3333/api/business-partner"
                        #server_url = "http://172.16.11.32:3333/api/business-partner/business-partners"
        ...
        #把資料轉為json
                        ...
                        # 顯示伺服器回應
                        if isinstance(response, dict) and response.get("message") == "Business partner created successfully":
